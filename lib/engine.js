...
// );
        ...
        drawPlayerOnMap: function (canvas, player, map) {
            ...
            var fViewRightX = (6) * Math.cos(fFOV/2) + player.pos.x;
            var fViewRightY = (6) * Math.sin(fFOV/2) + player.pos.y;
            var fViewLeftX = (6) * Math.cos(-fFOV/2) + player.pos.x;
            var fViewLeftY = (6) * Math.sin(-fFOV/2) + player.pos.y;
