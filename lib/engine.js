...
define(function () {
    ...
    var /*
            TODO: Remove, used for picking texture
        */
        face = [],

        /*
            TODO: Remove, used for setting texture
        */
        bit = [],
    ...
    imageObj = new Image();
    imageObj.src = "file:///Users/ricallinson/Js/jsrce/examples/basic/wall.gif";
        ...
        drawView: function (canvas, player, map, samples, pixel) {
            ...
            for (i = 0; i < samples; i = i + 1) {
                ...
                if (true) { // use textures
                    ...
                    color = Math.round(200 - (d2*20));
                    canvas.ctx.fillStyle = "rgba(0,0,0, "+d2/10+")"; //"#" + rgbToHex(color, color, color);
