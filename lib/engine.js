        ...
        */
        ...
        drawView: function (canvas, player, map, samples, pixel) {
            ...
            for (i = 0; i < samples; i = i + 1) {
                ...
                canvas.ctx.fillStyle = "rgba(" + color + ", " + color + ", " + color + ", 0.5)";//"#" + rgbToHex(color, color, color);
                // x, y, width, height
                ...
                var grad = canvas.ctx.createLinearGradient(0, h, 0, canvas.height);
                ...
                canvas.ctx.moveTo(sample * pixel, ((canvas.height / 2) - h * z) + h);
                canvas.ctx.lineTo(sample * pixel, canvas.height);
